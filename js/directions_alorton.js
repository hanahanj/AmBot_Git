...
(function(mapDemo, $, undefined) {
	mapDemo.Directions = (function() {
     ...
     map = new google.maps.Map($Selectors.mapCanvas, {
     	...
     	center: new google.maps.LatLng(  38.598275, -90.124939),	
     	zoom: 15,
     	styles: styles,
     ...
     var Milam_Loc = new google.maps.LatLng(    38.598275, -90.124939);
     
     // Use ABMarker4 or resize marker to a bigger pixel size to make bigger
