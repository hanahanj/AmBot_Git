...
$(document).ready(function(){
	...
	$(".directionButton").click(function(){
		if (directionsPanelIn == true){
			$("#directionsPanel").animate({left: '-330px'}, 500); //1st variable indicate height or width; 2nd variable indicates time in millis
...
(function(mapDemo, $, undefined) {
	mapDemo.Directions = (function() {
     ...
     map = new google.maps.Map($Selectors.mapCanvas, {
     	...
     	center: new google.maps.LatLng(   38.797708, -90.098816),	
     	zoom: 15,
     	styles: styles,
