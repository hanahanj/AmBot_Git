...
$(document).ready(function(){
	...
	function initialize() {
     ...
     var markers = [
	    ...
	    ['Granite City', 38.701494, -90.148979, 'insert Site'],
	    ...
	    ['Kidd', 38.144126, -90.170092, 'kidd.html'],
	    ['Laclede Steel',  38.885131, -90.143912, 'lacledeSteel.html'],
	    ['Lewis & Clark Historical Site', 38.802470, -90.102143, 'lewisClark.html'],
	    ['Lock & Dam #27', 38.702655, -90.180801, 'lock27.html'],
	    ['Lowland Forests', 38.417596, -90.262183, 'lowlandForests.html'],
	    ['McKinley Bridge & Tri-Cities Roadside Park', 38.66825, -90.174736, 'mcKinley.htm'],
...
['<div id="bodyContent">' + '<p>Camp DuBios</p>'],
